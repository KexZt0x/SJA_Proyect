...
export class AcMovimientosComponent implements OnInit {
  ...
  actualizarFormulario() {
    this.movimientoForm.patchValue({
      ...
      solicitanteEquipo:this.movimiento?.SolicitanteEquipo || '',
      correoSolicitante:this.movimiento?.CorreoSolicitante || '',
      telefonoSolicitante:this.movimiento?.TelefonoSolicitante || '',
  ...
  onSubmit() {
    if (this.movimientoForm.valid && this.movimiento) {
      ...
      const movimientoActualizado = new MovimientoEDModel(
        ...
        this.movimientoForm.get('solicitanteEquipo')?.value,
        this.movimientoForm.get('correoSolicitante')?.value,
        this.movimientoForm.get('telefonoSolicitante')?.value,
